...
class AssetController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $check_count_category               = Asset::where('ass_category_id',$request->ass_category_id)->count();
        ...
        $create_asset->ass_registration_code    = $registration_code.'/'.$category->ctg_code.'/'.$origin->ori_code.'/'.$request->ass_year;
