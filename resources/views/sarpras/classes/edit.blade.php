                    ...
                    <form class="form-horizontal form-label-left" method="post" action="">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="text"name="cls_level" class="form-control" value="{{$classes->cls_level}}" placeholder="Tingkatan "
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <select id="choose" class="form-control" name="cls_major_id" onchange="yesnoCheck(this);" wire:model="cls_major_id">
                                    <option value="{{$classes->cls_major_id}}">{{$classes->cls_major->mjr_name}}</option>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="number"name="cls_number" value="{{$classes->cls_number}}" class="form-control" placeholder="nomor kelas "
