                ...
                <form class="form-horizontal form-label-left" method="post" action="">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input type="text"name="mjr_name" class="form-control" placeholder="Nama Jurusan " wire:model="mjr_name">
                            @error('mjr_name') <span class="error text-">{{ $message }}</span> @enderror
